...
local soundFile = audio.loadStream("assetsAudio/processo_noturno.mp3") -- Substitua pelo caminho do seu arquivo de áudio
local soundText
local soundOn
...
function scene:create(event)
    ...
    local background = display.newImageRect(sceneGroup, "assetsN/pag2-1.png", display.contentWidth, display.contentHeight)
