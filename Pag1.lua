...
local soundFile = audio.loadStream("assetsAudio/Fotossíntese_ Fase_Clara.mp3") 
local soundText
local soundOn
...
function scene:create(event)
    ...
    local background = display.newImageRect(sceneGroup, "assetsN/pag1.png", display.contentWidth, display.contentHeight)
