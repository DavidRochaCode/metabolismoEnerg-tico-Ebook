...
local soundFile = audio.loadStream("assetsAudio/ver_processo.mp3") -- Substitua pelo caminho do seu arquivo de áudio
local soundText
local soundOn
...
function scene:create(event)
    ...
    local background = display.newImageRect(sceneGroup, "assetsN/pag5-1.png", display.contentWidth, display.contentHeight)
